...
from Sigma.features import date_time
from Sigma.features import launch_app
from Sigma.features import website_open
from Sigma.features import weather
from Sigma.features import wikipedia
from Sigma.features import news
from Sigma.features import send_email
from Sigma.features import google_search
from Sigma.features import google_calendar
from Sigma.features import note
from Sigma.features import system_stats
from Sigma.features import loc
...
class VoiceAssistant:
    ...
    def tts(text):
        ...
        try:
            ...
            t = "Sorry I couldn't understand and handle this input: {0}".format(e)
            print(t)
            return False
